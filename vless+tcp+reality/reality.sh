...
echo
echo "vless://$UUID@$(hostname -I | awk '{print $1}'):$PORT?encryption=none&flow=xtls-rprx-vision&security=reality&pbk=$PUBLIC_KEY&fp=firefox&sid=6a96&sni=$FALLBACK_DOMAIN&type=tcp#Reality"
echo
echo "=========================================="
